...
<span style="color:red;"><?php echo validation_errors(); ?></span>
        ...
        <div class="row"><div class="sixteen columns"><label for="type">Type</label>
...
<input name="from" type="text" id="from" value="<?php echo set_value('from', $data->from);?>" style="width:100px"/></span><span style="float:left;padding-right:10px">
<label for="to">End Date</label>
<input name="to" type="text" id="to" value="<?php echo set_value('to', $data->to);?>" style="width:100px"/></span><span style="float:left;padding-right:10px"></div></div>
        <div class="row"><div class="sixteen columns">
        <button onclick="submitForm(1)">Get Quickbooks Report</button>
        <button onclick="submitForm(2)">Get Waste Invoice Submission Report</button> 
