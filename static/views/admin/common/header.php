...
<article class="container">
    ...
    <header> <a href="<?php echo base_url();?>"><img src="<?php echo base_url();?>images/logo.png" width="250" height="112" alt="Astor Home"></a>
          <?php if (!isset($hideAdminMenu)):?><div style="float:right;margin-top:10px; text-align:right; font-size:90%;">Welcome <?php echo $_loggedUser;?> &nbsp;&nbsp; <a href="<?php echo base_url();?>admin/Accounts/Update">Account</a> &nbsp;&nbsp;&nbsp; <a href="<?php echo  base_url();?>admin/Help">Help</a> &nbsp;&nbsp;&nbsp; <a href="<?php echo base_url();?>admin/Auth/logOut">Logout</a>
          <br/>Call 800-278-6726 or <a href="<?php echo base_url();?>RequestService">Get Support</a>
          <?php else:?>
          <div style="float:right;margin-top:10px; text-align:right; font-size:90%;">Welcome Guest! Please <a href="<?php echo base_url() . (empty($_controller) ? 'admin/Auth' : 'Front');?>">Login here</a>.
          <?php endif;?>
