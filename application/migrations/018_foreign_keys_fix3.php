...
class Migration_Foreign_keys_fix3 extends CI_Migration {
    ...
    public function up() {
        ...
        */
        ...
        $this->db->query("
			...
			ADD CONSTRAINT material_FK1 FOREIGN KEY (materialId)
        ...
        $this->db->query("
			ALTER TABLE `WasteInvoiceServices` ADD CONSTRAINT invoiceId_FK1 FOREIGN KEY ( `invoiceId` ) REFERENCES `WasteInvoices` (
			`id`
			) ON DELETE CASCADE ON UPDATE NO ACTION ;
        ");  
        /*-------------------------------------------------------------*/
