...
class districtmodel extends CI_Model {
	 ...
	 */
	public function getStoresCount($id)
	{
		$s = "
		SELECT
	...
	/**
	 * @param integer id `District`.`number`
	 * @return double sum of the Square Footages of the Stores belonging to this deistrict
	 */
	public function getStoresSqft($id)
	{
		$s = "
		SELECT
...
*/
	 ...
	 * @return array mixed 
	 */
	function getServices($id, $iDisplayStart=0, $iDisplayLength=10000, $sortColumn='last_updated', $sortDir='DESC')
	{
		$s = "
		SELECT 
			SQL_CALC_FOUND_ROWS
	 ...
	 * @return array mixed 
	 */
	function getLocations($id, $iDisplayStart=0, $iDisplayLength=10000, $sortColumn='last_updated', $sortDir='DESC')
	{
		$s = "
		SELECT
			SQL_CALC_FOUND_ROWS
