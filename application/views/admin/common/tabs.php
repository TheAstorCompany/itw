<ul>
 ...
 -->    
    ...
    <li <?php if ($_controller == 'ConstructionInvoice'):?>id="selected_tab"<?php endif; ?>><a href="<?php echo base_url();?>admin/ConstructionInvoice/Add">Enter Construction Invoice</a></li>
</ul>
