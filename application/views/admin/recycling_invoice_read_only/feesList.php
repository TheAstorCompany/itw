	...
	<?php if(isset($data->invoiceSum["materials"]) && count($data->invoiceSum["materials"])) {?>
		<strong>Materials</strong>
              ...
              <?php foreach($data->invoiceSum["materials"] as $key=>$temp) {?>
                ...
                {echo $data->allMaterials[$temp["materialId"]];?> -$<?php } echo number_format($temp["quantity"]*$temp["pricePerUnit"], 2)?>&nbsp;&nbsp;&#8226;&nbsp;<strong>&nbsp;<?php echo $temp["quantity"]?> Tons</strong> @ <strong>$<?php echo number_format($temp["pricePerUnit"], 2)?></strong>&nbsp; </li>
               <?php }?>
              </ol>
    <?php }?>
