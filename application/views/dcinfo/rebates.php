                ...
                <div id="tabs" style="border:0px;">
                    ...
                    <div style="border:2px solid #7ABF53; padding: 10px;">
                        ...
                        <span style="float:right">
                            <a href="<?php echo base_url() . 'Dcinfo/Rebates/' . $id; ?>'?export=1" class="button">Export CSV</a>
                        </span>
                        <style type="text/css">
                            .alignright {
                                text-align: right;
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" class="display" id="invoices_tbl" width="100%">
                            <thead>
                            <tr>
                                <th style="width: 100px;">Rebate Date</th>
                                <th>Vendor</th>
                                <th style="width: 100px;">Material</th>
                                <th style="width: 100px;">Tons</th>
                                <th style="width: 100px;">Rebate</th>
                            </tr>
                            </thead>
                            <tfoot>
                            <tr>
                        ...
                        <script type="text/javascript">
                            $(function() {
                                $("#invoices_tbl").dataTable({
                                    ...
                                    "bFilter"			: false,
                                    "bLengthChange"		: false,
                                    "sAjaxSource"		: "<?php echo base_url() . 'Dcinfo/ajax_Rebates/' . $id; ?>",
                                    "aoColumnDefs"      : [{"sClass": "alignright", "aTargets": [4]}]
                                });
                            });
                        </script>
