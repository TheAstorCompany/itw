	...
	<div class="row">
		<div class="sixteen columns">
			<div id="tabs" style="border:0px;">
				<ul>
					<li id="selected_tab"><a href="' . base_url() . 'Dcinfo/Waste/' . $id . '">Waste</a></li>
...
if(!empty($tblData['rows']))
{
	echo '
					<span style="float:right">
						<a href="' . base_url() . 'Dcinfo/Waste/' . $id . '?print=1&from=' . urlencode($from) . '&to=' . urlencode($to) . '" class="button" target="_blank">Printer Friendly</a> 
						<a href="' . base_url() . 'Dcinfo/Waste/' . $id . '?export=1&from=' . urlencode($from) . '&to=' . urlencode($to) . '" class="button">Export CSV</a>
					</span>';
}

echo
					form_open('Dcinfo/Waste/' . $id, array('method'=>'get')) . '
