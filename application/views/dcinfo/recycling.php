	...
	<div class="row">
		<div class="sixteen columns">
			<div id="tabs" style="border:0px;">
				<ul>
					<li><a href="' . base_url() . 'Dcinfo/Waste/' . $id . '">Waste</a></li>
					<li id="selected_tab"><a href="' . base_url() . 'Dcinfo/Recycling/' . $id . '">Recycling</a></li>
					<li><a href="' . base_url() . 'Dcinfo/CostSavings/' . $id . '">Cost/Savings</a></li>
					<li><a href="' . base_url() . 'Dcinfo/Invoices/' . $id . '">Invoices</a></li>
					<li><a href="' . base_url() . 'Dcinfo/SupportRequests/' . $id . '">Support Requests</a></li>
					<li><a href="' . base_url() . 'Dcinfo/SiteInfo/' . $id . '">Site Info</a></li>
				</ul>
...
if(!empty($recycling['rows']))
{
	echo '
					<span style="float:right">
						<a href="' . base_url() . 'Dcinfo/Recycling/' . $id . '?print=1&from=' . urlencode($from) . '&to=' . urlencode($to) . '" class="button" target="_blank">Printer Friendly</a> 
						<a href="' . base_url() . 'Dcinfo/Recycling/' . $id . '?export=1&from=' . urlencode($from) . '&to=' . urlencode($to) . '" class="button">Export CSV</a>
					</span>';
}

echo
					form_open('Dcinfo/Recycling/' . $id, array('method'=>'get')) . '
...
if(!empty($recycling['rows']))
{
	...
	echo '
					  ...
					  <tfoot>
						<tr>
							<th>' . $recycling['sum']['DC_count'] . ' DCs</th>
