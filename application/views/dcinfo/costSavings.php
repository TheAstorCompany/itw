		...
		<div class="sixteen columns">
			<div id="tabs" style="border:0px;">
				<ul>
					...
					<li><a href="' . base_url() . 'Dcinfo/Recycling/' . $id . '">Recycling</a></li>
					<li id="selected_tab"><a href="' . base_url() . 'Dcinfo/CostSavings/' . $id . '">Cost/Savings</a></li>
...
if(!empty($tblData['rows']))
{
	echo '
					<span style="float:right">
						<a href="' . base_url() . 'Dcinfo/CostSavings/' . $id . '?print=1&from=' . urlencode($from) . '&to=' . urlencode($to) . '" class="button" target="_blank">Printer Friendly</a> 
						<a href="' . base_url() . 'Dcinfo/CostSavings/' . $id . '?export=1&from=' . urlencode($from) . '&to=' . urlencode($to) . '" class="button">Export CSV</a>
					</span>';
}

echo
					form_open('Dcinfo/CostSavings/' . $id, array('method'=>'get')) . '
