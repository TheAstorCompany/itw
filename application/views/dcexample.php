...
<script type="text/javascript">
    ...
    <script type="text/javascript">
      ...
      google.setOnLoadCallback(drawVisualization8);
        ...
        <div class="content">
             <div class="row"><div class="two columns"><a href="javascript:javascript:history.go(-1)" class="button"><- Go back</a></div></div>
                <div class="row"><div class="four columns"><h1>Orlando</h1></div><div class="two columns">Square Footage<h5>
          2000 sqft</h5>
          </div><div class="two columns">Diversion Rate<h5>
          75%</h5>
            ...
            <tr style="border-bottom:1px solid #ddd">
              ...
              <td><h5>jjones@walgreens.com</h5></td>
          </tr>
            <tr>
              <td><h5>Tommy Rich</h5></td>
              <td><h5>Ast Manager</h5></td>
              <td><h5>123-456-7890</h5></td>
              <td><h5>trich@walgreens.com</h5></td>
          </tr>
          </table>
       ...
       <div id="tabs" style="border:0px;">
			<ul><li><a href="#tabs-1">Waste</a></li>
          ...
          <div id="tabs-1" style="border:2px solid #7ABF53;"><span style="float:left;padding-right:10px"><label for="from">Start Date</label>
<input name="from" type="text" id="from" value="09/01/2011" style="width:100px"/></span><span style="float:left;padding-right:10px">
<label for="to">End Date</label>
<input name="to" type="text" id="to" value="03/01/2012" style="width:100px"/></span><span style="float:right"><a href="<?=base_url()?>Company/reportsAllDCWaste" class="button" target="_blank">Printer Friendly</a> <a href="<?=base_url()?>Company/reportsAllDCWasteCSV" class="button">Export CSV</a></span><br style="clear:both;">
         
            <div id="wastetypeschart" style="width: 350px; height: 250px; float:left"></div><div id="visualization2" style="width: 400px; height: 300px; float:left"></div>
            <table cellpadding="0" cellspacing="0" border="0" class="display" id="wastelist" width="100%">
              ...
              <tbody>
                ...
                <tr class="even gradeA">
                  <td class="even gradeB">Orlando </td>
                  <td>10,000</td>
                  <td>11/2011</td>
                  <td class="odd gradeA">100</td>
                  <td class="odd gradeA">6</td>
                ...
                <tr class="even gradeA">
                  <td class="odd gradeA">Orlando </td>
                  <td>10,000</td>
                  <td class="odd gradeA">9/2011</td>
                  <td class="odd gradeA">100</td>
                  <td class="odd gradeA">6</td>
                  <td class="odd gradeA">6</td>
                  <td class="odd gradeA">6</td>
                ...
                <tr class="odd gradeA">
                  <td class="even gradeA">Orlando </td>
                  <td>10,000</td>
                  <td class="even gradeA">8/2011</td>
                  <td>100</td>
                  <td>6</td>
                  <td>6</td>
                  <td>6</td>
                ...
                <tr  class="odd gradeA">
                  <td>Orlando </td>
                  <td>10,000</td>
                  <td class="even gradeA">2/2011</td>
                  <td>100</td>
                  <td>6</td>
                  <td>6</td>
                  <td>6</td>
                ...
                <tr  class="odd gradeA">
                  <td class="even gradeB">Orlando </td>
                  <td>10,000</td>
                  <td class="even gradeA">8/2010</td>
                  <td>100</td>
                  <td>6</td>
                  <td>6</td>
                  <td>6</td>
          ...
          <div id="tabs-2" style="border:2px solid #7ABF53;"><span style="float:left;padding-right:10px"><label for="from">Start Date</label>
<input name="from" type="text" id="from" value="09/01/2011" style="width:100px"/></span><span style="float:left;padding-right:10px">
<label for="to">End Date</label>
<input name="to" type="text" id="to" value="03/01/2012" style="width:100px"/></span><span style="float:right"><a href="<?=base_url()?>Company/reportsAllDCWaste" class="button" target="_blank">Printer Friendly</a> <a href="<?=base_url()?>Company/reportsAllDCWasteCSV" class="button">Export CSV</a></span><br style="clear:both;"><div id="allrecyclechart" style="width: 350px; height: 250px; float:left"></div><div id="visualization" style="width: 600px; height: 300px;float:left;"></div>
...
<h3>&nbsp;</h3>
		  ...
		  <div id="tabs-3" style="border:2px solid #7ABF53;"><span style="float:left;padding-right:10px"><label for="from">Start Date</label>
<input name="from" type="text" id="from" value="09/01/2011" style="width:100px"/></span><span style="float:left;padding-right:10px">
<label for="to">End Date</label>
<input name="to" type="text" id="to" value="03/01/2012" style="width:100px"/></span><span style="float:right"><a href="<?=base_url()?>Company/reportsAllDCWaste" class="button" target="_blank">Printer Friendly</a> <a href="<?=base_url()?>Company/reportsAllDCWasteCSV" class="button">Export CSV</a></span><br style="clear:both;"><div id="invoicechart" style="width: 350px; height: 180px;float:left"></div><div id="savingschart" style="width: 350px; height: 180px;float:left"></div><div id="netvisualization" style="width: 700px; height: 300px;float:left"></div><br>
  ...
  <tr class="odd gradeA">
    <td>Orlando</td>
    <td><a href="<?=base_url()?>admin/WasteInvoice/AddEdit">1001</a></td>
    <td>01/01/12</td>
    <td>01/01/12</td>
    <td>32458</td>
    <td>ABC Hauler</td>
  ...
  <tr class="even gradeA">
    <td>Orlando</td>
    <td><a href="<?=base_url()?>admin/WasteInvoice/AddEdit">1180</a></td>
    <td>01/01/12</td>
    <td>01/01/12</td>
    <td>32458</td>
    <td>ABC Hauler</td>
  ...
  <tr class="odd gradeA">
    <td>Orlando</td>
    <td><a href="<?=base_url()?>admin/WasteInvoice/AddEdit">1214</a></td>
    <td>01/01/12</td>
    <td>01/01/12</td>
    <td>32458</td>
    <td>ABC Hauler</td>
  ...
  <tr class="even gradeA">
    <td class="even gradeX">Orlando</td>
    <td><a href="<?=base_url()?>admin/WasteInvoice/AddEdit">1427</a></td>
    <td>01/01/12</td>
    <td>01/01/12</td>
    <td>32458</td>
    <td>ABC Hauler</td>
  ...
  <tr class="odd gradeA">
    <td class="odd gradeX">Orlando</td>
    <td><a href="<?=base_url()?>admin/WasteInvoice/AddEdit">1487</a></td>
    <td>01/01/12</td>
    <td>01/01/12</td>
    <td>32458</td>
    <td>ABC Hauler</td>
  ...
  <tr class="even gradeA">
    <td>Orlando</td>
    <td><a href="<?=base_url()?>admin/WasteInvoice/AddEdit">1572</a></td>
    <td>01/01/12</td>
    <td>01/01/12</td>
    <td>32458</td>
    <td>ABC Hauler</td>
  ...
  <tr class="odd gradeA">
    <td>Orlando</td>
    <td><a href="<?=base_url()?>admin/WasteInvoice/AddEdit">1598</a></td>
    <td>01/01/12</td>
    <td>01/01/12</td>
    <td>32458</td>
  ...
  <tr class="even gradeA">
    <td>Orlando</td>
    <td><a href="<?=base_url()?>admin/WasteInvoice/AddEdit">1616</a></td>
    <td>01/01/12</td>
  ...
  <tr class="odd gradeA">
    <td>Orlando</td>
    <td><a href="<?=base_url()?>admin/WasteInvoice/AddEdit">1874</a></td>
    <td>01/01/12</td>
  ...
  <tr class="even gradeA">
    <td>Orlando</td>
    <td ><a href="<?=base_url()?>admin/WasteInvoice/AddEdit">1918</a></td>
    <td >01/01/12</td>
    <td class="odd gradeA">01/01/12</td>
    <td>32458</td>
    <td>ABC Hauler</td>
  ...
  <tr class="odd gradeA">
    <td>Orlando</td>
    <td ><a href="<?=base_url()?>admin/WasteInvoice/AddEdit">2055</a></td>
    <td >01/01/12</td>
    <td class="even gradeA">01/01/12</td>
    <td>32458</td>
    <td>ABC Hauler</td>
  ...
  <tr  class="even gradeA">
    <td>Orlando</td>
    <td ><a href="<?=base_url()?>admin/WasteInvoice/AddEdit">2077</a></td>
    <td >01/01/12</td>
    <td class="odd gradeA">01/01/12</td>
    <td>32458</td>
    <td>ABC Hauler</td>
	...
	<tfoot>
		<tr>
		  ...
		  <th>$100,00 Total</th>
            ...
            <div id="tabs-5" style="border:2px solid #7ABF53;"><span style="float:right"><a href="<?=base_url()?>Company/reportsAllDCWaste" class="button" target="_blank">Printer Friendly</a> <a href="<?=base_url()?>Company/reportsAllDCWasteCSV" class="button">Export CSV</a></span><table cellpadding="0" cellspacing="0" border="0" class="display" id="callslist" width="100%">
	<thead>
		<tr>
		  <th>Location</th>
			<th>Service#</th>
...
<div id="tabs-6" style="border:2px solid #7ABF53;"><span style="float:right"><a href="<?=base_url()?>Company/reportsAllDCWaste" class="button" target="_blank">Printer Friendly</a> <a href="<?=base_url()?>Company/reportsAllDCWasteCSV" class="button">Export CSV</a></span>
Addresses
  <h5>123 Main St, 
                  Manhattan, NY 00120</h5><h5>123 Main St, 
                  Manhattan, NY 00120</h5><br>
