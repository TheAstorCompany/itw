...
<div class="content">
		...
		<div class="sixteen columns">
			<div id="tabs" style="border:0px;">
				<ul>
					...
					<li id="selected_tab"><a href="' . base_url() . 'Districtinfo/Services/' . $id . '">Services</a></li>
	...
	echo '
					<span style="float:right">
						<a href="' . base_url() . 'Districtinfo/Services/' . $id . '?print=1" class="button" target="_blank">Printer Friendly</a> 
						<a href="' . base_url() . 'Districtinfo/Services/' . $id . '?export=1" class="button">Export CSV</a>
					</span>
					...
					<script type="text/javascript">
						$(function() {
							$("#invoices_tbl").dataTable({
								...
								"bFilter"			: false,
								"bLengthChange"		: false,
								"sAjaxSource"		: "' . base_url() . 'Districtinfo/ajax_Services/' . $id . '"
							});
						});
					</script>
