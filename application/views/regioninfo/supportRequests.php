		...
		<div class="sixteen columns">
			<div id="tabs" style="border:0px;">
				<ul>
					...
					<li id="selected_tab"><a href="' . base_url() . 'Regioninfo/SupportRequests/' . $name . '">Support Requests</a></li>
...
if(!empty($support_requests['rows']))
{
	echo '
					<span style="float:right">
						<a href="' . base_url() . 'Regioninfo/SupportRequests/' . $name . '?print=1" class="button" target="_blank">Printer Friendly</a> 
						<a href="' . base_url() . 'Regioninfo/SupportRequests/' . $name . '?export=1" class="button">Export CSV</a>
					</span>
					...
					<script type="text/javascript">
						$(function() {
							$("#data_tbl").dataTable({
								...
								"bFilter"			: false,
								"bLengthChange"		: false,
								"sAjaxSource"		: "' . base_url() . 'Regioninfo/ajax_SupportRequests/' . $name . '"
							});
						});
					</script>
